...
namespace Xamarin.Demos.Droid.Renderers
{
    public static class FontExtensions
    {
        ...
        internal static Typeface ToTypeFace(this string fontfamily, FontAttributes attr = FontAttributes.None)
        {
            ...
            {
                result = Typeface.CreateFromAsset(global::Android.App.Application.Context.Assets, FontNameToFontFile(fontfamily));
            }
            else
            {
        ...
        internal static Typeface ToTypeface(this IFontElement self)
        {
            ...
            {
                result = Typeface.CreateFromAsset(global::Android.App.Application.Context.Assets, FontNameToFontFile(self.FontFamily));
            }
            else
            {
                var style = ToTypefaceStyle(self.FontAttributes);
